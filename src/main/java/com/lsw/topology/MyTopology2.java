...
//		hbConf.put("hbase.rootdir", "hdfs://master:9000/hbase");
		hbConf.put("hbase.rootdir", "hdfs://master:8020/apps/hbase/data");
		// }
		...
		.withRowKeyField("rowkey").withColumnFields(new Fields("up","timestamp","realtime"))
		.withCounterFields(new Fields("upS")).withColumnFamily("cf");
		
		//设置入库的表名为lsw2,映射，以及HBase的根目录信息
		HBaseBolt hbase = new HBaseBolt("test", mapper)
